...
public class RequestBuilderView implements RequestSelectionListener {
    ...
    /** 从历史记录加载请求配置到 UI */
    public void loadFromHistory(com.jcurl2.model.HistoryRecord record) {
