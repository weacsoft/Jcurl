...
import com.jcurl.config.JcurlConfig;
import com.jcurl.model.Settings;
import com.jcurl.ui.frame.MainFrame;
...
public class JcurlApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(JcurlApplication.class);
    ...
    public static void main(String[] args) {
        ...
        ConfigurableApplicationContext context =
                new SpringApplicationBuilder(JcurlConfig.class)
