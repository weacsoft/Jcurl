 ...
 *   settings.json   — 用户设置
 */
@SpringBootApplication(scanBasePackages = "com.jpostman")
public class JPostmanConfig {

    @Value("${jpostman.data-dir}")
