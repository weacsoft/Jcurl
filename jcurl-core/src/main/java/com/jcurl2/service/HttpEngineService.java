...
import com.jcurl2.http.TimingEventListener;
...
import com.jcurl2.model.dto.TimingMetrics;
import com.jcurl2.plugin.PluginService;
import com.jcurl2.plugin.extension.RequestExecutorExtension;
...
public class HttpEngineService {
    ...
    /** 构建请求体 */
    private RequestBody buildBody(com.jcurl2.model.component.RequestBody bodyConfig, String method) {
        // GET / HEAD 不能有 body
    ...
    private RequestBody buildMultipartBody(com.jcurl2.model.component.RequestBody bodyConfig) {
    ...
    private RequestBody buildFormBody(com.jcurl2.model.component.RequestBody bodyConfig) {
    ...
    private RequestBody buildRawBody(com.jcurl2.model.component.RequestBody bodyConfig) {
    ...
    /** binary: 单文件二进制流 */
    private RequestBody buildBinaryBody(com.jcurl2.model.component.RequestBody bodyConfig) {
        // 优先使用 Base64 文件内容
