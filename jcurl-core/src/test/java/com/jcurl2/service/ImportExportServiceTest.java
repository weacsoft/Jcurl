...
class ImportExportServiceTest {
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        registry.add("jcurl2.data-dir", () -> tempDir.toString());
    }
    ...
    class PostmanV21Export {
        ...
        void exportWithHeaders() throws Exception {
            ...
            // 添加 header
            RequestNode req = (RequestNode) collection.getItems().get(0);
            req.getHeaders().add(new com.jcurl2.model.component.Header("Accept", "application/json"));
        ...
        void exportWithVariables() throws Exception {
            ...
            collection.getVariables().add(new com.jcurl2.model.component.Variable("baseUrl", "https://api.example.com"));
            collectionService.saveCollection(collection);
