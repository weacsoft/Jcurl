...
class CollectionSerializationTest {
    ...
    void shouldSerializeAndDeserializeNestedTree() throws Exception {
        ...
        col.getVariables().add(new com.jpostman2.model.component.Variable("token", "abc123"));
    ...
    void shouldSerializeEnvironmentAndGlobals() throws Exception {
        ...
        env.getVariables().add(new com.jpostman2.model.component.Variable("base_url", "http://localhost:8080"));
        env.getVariables().add(new com.jpostman2.model.component.Variable("secret_key", "encoded", true));
        ...
        globals.getVariables().add(new com.jpostman2.model.component.Variable("global_var", "global_value"));
