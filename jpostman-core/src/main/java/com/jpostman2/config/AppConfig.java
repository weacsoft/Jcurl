 ...
 */
@SpringBootApplication(scanBasePackages = "com.jpostman2")
public class AppConfig {
    ...
    /**
     * 应用配置属性绑定(对应 application.yml 中 jpostman2.* 前缀)。
     */
    @Bean
    @ConfigurationProperties(prefix = "jpostman2")
