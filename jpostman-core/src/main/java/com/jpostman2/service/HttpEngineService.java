...
import com.jpostman2.http.TimingEventListener;
...
import com.jpostman2.plugin.PluginService;
...
public class HttpEngineService {
    ...
    /** 构建请求体 */
    private RequestBody buildBody(com.jpostman2.model.component.RequestBody bodyConfig, String method) {
        // GET / HEAD 不能有 body
    ...
    private RequestBody buildMultipartBody(com.jpostman2.model.component.RequestBody bodyConfig) {
    ...
    private RequestBody buildFormBody(com.jpostman2.model.component.RequestBody bodyConfig) {
    ...
    private RequestBody buildRawBody(com.jpostman2.model.component.RequestBody bodyConfig) {
    ...
    /** binary: 单文件二进制流 */
    private RequestBody buildBinaryBody(com.jpostman2.model.component.RequestBody bodyConfig) {
        // 优先使用 Base64 文件内容
